var questions = [				
["____________ ng bagong libro sa Filipino na available sa bookstore.", "May", "Mayroon", "Meyron", "Mey", "B", "Wastong<br> Gamit"],
["Ipinagmamalaki ____________ lubos na ako ay isang Atheneon.", "kung", "kong", "mong", "mung", "B", "Wastong<br> Gamit"],
["Pumunta ka ____________ para makuha mo ang pasalubong ni Tita Lina.", "dito", "rito", "doon", "diyan", "B", "Wastong<br> Gamit"],
["Mahal ____________ ang talent fee ni Ryzza Mae bilang host sa Eat Bulaga.", "raw", "at", "ng", "daw", "D", "Wastong<br> Gamit"],
["Ika ____________ lima siya sa ranking ng mga atleta.", "labin", "labim", "labing", "labbin", "A", "Wastong<br> Gamit"],
["Sinabi ____________ ng mga Ginebra fans na dinaya lang ang resulta sa laban nila ng koponan ng Alaska.", "din", "nila", "sila", "rin", "D", "Wastong<br> Gamit"],
["____________ bagong patakaran bang ipapatupad ang DepEd sa taong ito?", "Meyron", "Mayroon", "May", "Mayron", "C", "Wastong<br> Gamit"],
["____________ puwede lang sana, unahin nyo muna ang pagtatrabaho sa ating bansa bago sa mga dayuhan.", "Kung", "Kong", "Ka", "Ko", "A", "Wastong<br> Gamit"],
["____________ mo muna kung maayos itong <i>ipad</i> bago mo bilhin.", "Subukin", "Subukan", "Sanayin", "Eksamin", "A", "Wastong<br> Gamit"],
["____________ di lang talaga nagbrown-out, matatapos ko n asana ang aking proyekto.", "Kung", "Kong", "Mong", "Mung", "A", "Wastong<br> Gamit"],
["Tumakbo ____________ mabilis ang manlalaro.", "nang", "ng", "at", "sa", "B", "Wastong<br> Gamit"],
["Si Sam at ako ay pupunta sa Lola ko. ____________ ay kakain ng masarap doon.", "Kami", "Kayo", "Sila", "Tayo", "A", "Wastong<br> Gamit"],
["Sina Rain at Rian ay magkapatid. ____________ ay laging nagtutulungan.", "Kami", "Kayo", "Sila", "Tayo", "C", "Wastong<br> Gamit"],
["Pumapasok ang mga bata ____________ paaralan araw-araw.", "sa", "ng", "at", "nang", "A", "Wastong<br> Gamit"],
["Si Nelly, Trisha at ikaw ang susunod na sasakay sa kotse. ____________ ay pupunta sa park.", "Kami", "Kayo", "Sila", "Sina", "B", "Wastong<br> Gamit"],
["____________ mo ang pawis sa noon ng iyong kapatid.", "Pahirin", "Pahiran", "Lapatan", "Lapitan", "A", "Wastong<br> Gamit"],
["____________ mo ng mantikilya ang tinapay ng lola mo.", "Pahirin", "Pahiran", "Lapatan", "Lapitan", "C", "Wastong<br> Gamit"],
["Walang sinuman ang pwedeng pumasok sa sinehan ____________ ang mga may ticket lamang.", "kundi", "kung di", "kondi", "kong di", "A", "Wastong<br> Gamit"],
["Siya ang ____________ hugas ng plato tuwing gabi.", "kita", "tiga", "taga", "kata", "C", "Wastong<br> Gamit"],
["Hindi matibay ang pagkagawa ng ____________.", "saraduhan", "pintuan", "sarado", "pinto", "D", "Wastong<br> Gamit"],
];
