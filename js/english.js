...
["assemble : convene :: categorize : ____________", "systematize", "congregate", "dismiss", "alternate", "A", "Single Word<br> Analogy"],
...
["unschooled : education ::________:________", "naïve : experience", "pristine : elegance", "miserly : money", "rude: ill-mannered", "A", "Double Word<br> Analogy"],
...
["<div class=\"divQuest text-justify\">1. Second, a good friend should be there when I needed him. I should be able to find him near me when I am in bad mood or when I have a problem. <br><br> 2. I think, these three qualities are the basic properties in a good friend. <br><br> 3. First, a good friend shouldn’t tell lies. I need to trust him so that I can talk to him. <br><br> 4. Finally, when necessary, he should criticize me so that I can change my undesirable behavior or see where I am wrong. <br><br> 5. There are three qualities that I need to see in a good friend. </div><br><br> Which should be the first sentence?", "1", "2", "3", "5", "D", "Logical Organization<br> of Ideas"],
["<div class=\"divQuest text-justify\">1. Second, a good friend should be there when I needed him. I should be able to find him near me when I am in bad mood or when I have a problem. <br><br> 2. I think, these three qualities are the basic properties in a good friend. <br><br> 3. First, a good friend shouldn’t tell lies. I need to trust him so that I can talk to him. <br><br> 4. Finally, when necessary, he should criticize me so that I can change my undesirable behavior or see where I am wrong. <br><br> 5. There are three qualities that I need to see in a good friend. </div><br><br> Which should be the second sentence?", "1", "2", "3", "5", "C", "Logical Organization<br> of Ideas"],
["<div class=\"divQuest text-justify\">1. Second, a good friend should be there when I needed him. I should be able to find him near me when I am in bad mood or when I have a problem. <br><br> 2. I think, these three qualities are the basic properties in a good friend. <br><br> 3. First, a good friend shouldn’t tell lies. I need to trust him so that I can talk to him. <br><br> 4. Finally, when necessary, he should criticize me so that I can change my undesirable behavior or see where I am wrong. <br><br> 5. There are three qualities that I need to see in a good friend. </div><br><br> Which should be the last sentence?", "1", "2", "3", "5", "B", "Logical Organization<br> of Ideas"],
["<div class=\"divQuest text-justify\">1. Kayla said, \"Mom I hate how I look\". <br><br> 2. One very beautiful clear night, a girl named Kayla and her mother were talking and looking up in the sky at the stars. <br><br> 3. \"Well Kayla you need to accept who you are and like it\", said Kayla’s mother. <br><br> 4. My hair is so ugly; there’s never anything to do with It. And my clothes – they’re awful. </div><br><br> Which should be the first sentence?", "1", "2", "3", "4", "B","Logical Organization<br> of Ideas"],
["<div class=\"divQuest text-justify\">1. Kayla said, \"Mom I hate how I look\". <br><br> 2. One very beautiful clear night, a girl named Kayla and her mother were talking and looking up in the sky at the stars. <br><br> 3. \"Well Kayla you need to accept who you are and like it\", said Kayla’s mother. <br><br> 4. My hair is so ugly; there’s never anything to do with It. And my clothes – they’re awful. </div><br><br> Which should be the third sentence?", "1", "2", "3", "4", "D", "Logical Organization<br> of Ideas"],
["<div class=\"divQuest text-justify\">1. Kayla said, \"Mom I hate how I look\". <br><br> 2. One very beautiful clear night, a girl named Kayla and her mother were talking and looking up in the sky at the stars. <br><br> 3. \"Well Kayla you need to accept who you are and like it\", said Kayla’s mother. <br><br> 4. My hair is so ugly; there’s never anything to do with It. And my clothes – they’re awful. </div><br><br> Which should be the last sentence?", "1", "2", "3", "4","C", "Logical Organization<br> of Ideas"],
["<div class=\"divQuest text-justify\">1. He recommended that Mr. Matters begin to eat more fruits and vegetables.<br><br>2. One day he woke up and didn’t feel so well.<br><br>3. He decided to go to see Dr. Jerome to see what the problem might be.<br><br>4. Mr. Matters was a very well-liked neighbor that we had for years.<br><br>5. Dr. Jerome did some blood work on Mr. Matters and he found out that his blood contains very few vitamins and minerals.</div><br><br> Which should be the first sentence?", "1", "2", "4", "5", "C", "Logical Organization<br> of Ideas"],
["<div class=\"divQuest text-justify\">1. He recommended that Mr. Matters begin to eat more fruits and vegetables.<br><br>2. One day he woke up and didn’t feel so well.<br><br>3. He decided to go to see Dr. Jerome to see what the problem might be.<br><br>4. Mr. Matters was a very well-liked neighbor that we had for years.<br><br>5. Dr. Jerome did some blood work on Mr. Matters and he found out that his blood contains very few vitamins and minerals.</div><br><br> Which should be the third sentence?", "1", "2", "3", "5", "C", "Logical Organization<br> of Ideas"],
["<div class=\"divQuest text-justify\">1. He recommended that Mr. Matters begin to eat more fruits and vegetables.<br><br>2. One day he woke up and didn’t feel so well.<br><br>3. He decided to go to see Dr. Jerome to see what the problem might be.<br><br>4. Mr. Matters was a very well-liked neighbor that we had for years.<br><br>5. Dr. Jerome did some blood work on Mr. Matters and he found out that his blood contains very few vitamins and minerals.</div><br><br> Which should be the fourth sentence?", "1", "2", "3", "5", "D", "Logical Organization<br> of Ideas"],
["<div class=\"divQuest text-justify\">1. As we age, both muscle mass and bone density can decrease, so improving the through strength training is important.<br><br>2. It is proven that aerobic exercise is good for the heart, which is very important to overall health.<br><br>3. All kinds of exercise have been shown to relieve depression, anxiety, and stress.<br><br>4. Strength training is important for maintaining muscle mass and improving bone density.<br><br>5. Exercise is really good for one’s physical and mental health.</div><br><br> Which should be the first sentence?", "1", "2", "3", "5", "D", "Logical Organization<br> of Ideas"],
["<div class=\"divQuest text-justify\">1. As we age, both muscle mass and bone density can decrease, so improving the through strength training is important.<br><br>2. It is proven that aerobic exercise is good for the heart, which is very important to overall health.<br><br>3. All kinds of exercise have been shown to relieve depression, anxiety, and stress.<br><br>4. Strength training is important for maintaining muscle mass and improving bone density.<br><br>5. Exercise is really good for one’s physical and mental health.</div><br><br> Which should be the first sentence?", "1", "2", "3", "5", "A", "Logical Organization<br> of Ideas"],
["<div class=\"divQuest text-justify\">1. As we age, both muscle mass and bone density can decrease, so improving the through strength training is important.<br><br>2. It is proven that aerobic exercise is good for the heart, which is very important to overall health.<br><br>3. All kinds of exercise have been shown to relieve depression, anxiety, and stress.<br><br>4. Strength training is important for maintaining muscle mass and improving bone density.<br><br>5. Exercise is really good for one’s physical and mental health.</div><br><br> Which should be the first sentence?", "1", "2", "3", "5", "C", "Logical Organization<br> of Ideas"],
["<div class=\"divQuest text-justify\"><p class=\"pQuest text-justify\">A woodpecker is a kind of bird. Woodpeckers are found all over the world except in the North and South poles, Australia, and New Zealand. There are over 200 different kinds of woodpeckers. The two largest woodpeckers, the Imperial Woodpecker and the Ivory-billed Woodpecker are most likely extinct. Animals that are extinct are no longer found on Earth.</p><br><p class=\"pQuest text-justify\">Woodpeckers have sharp bills of drilling into wood, and short, stiff tails which help prop them against tree trunks and branches. Woodpeckers also have very long tongues, which help them get at insects deep within trees. Woodpeckers are often heard drumming loudly on trees before they are seen, Woodpeckers can even become pests if they learn to drum on siding of a house.</p><br><p class=\"pQuest text-justify\">Woodpeckers can easily be attracted to backyard bird feeders with sunflower seeds or suet. Suet is a kind of animal fat hat is very tasty to woodpeckers and other birds.</p></div><br> Why do woodpeckers have long tongues?", "So they can drum on trees", "To eat seeds", "to get at insects within trees", "to get at insects on the ground", "C", "Reading<br> Comprehension"],
...
["<div class=\"divQuest text-justify\"><p class=\"pQuest text-justify\">A woodpecker is a kind of bird. Woodpeckers are found all over the world except in the North and South poles, Australia, and New Zealand. There are over 200 different kinds of woodpeckers. The two largest woodpeckers, the Imperial Woodpecker and the Ivory-billed Woodpecker are most likely extinct. Animals that are extinct are no longer found on Earth.</p><br><p class=\"pQuest text-justify\">Woodpeckers have sharp bills of drilling into wood, and short, stiff tails which help prop them against tree trunks and branches. Woodpeckers also have very long tongues, which help them get at insects deep within trees. Woodpeckers are often heard drumming loudly on trees before they are seen, Woodpeckers can even become pests if they learn to drum on siding of a house.</p><br><p class=\"pQuest text-justify\">Woodpeckers can easily be attracted to backyard bird feeders with sunflower seeds or suet. Suet is a kind of animal fat hat is very tasty to woodpeckers and other birds.</p></div><br> Woodpeckers are often:", "found in North Pole", "heard before they are seen", "found in Australia", "seen before they are heard", "B", "Reading<br> Comprehension"],
["<div class=\"divQuest text-justify\"><p class=\"pQuest text-justify\">A woodpecker is a kind of bird. Woodpeckers are found all over the world except in the North and South poles, Australia, and New Zealand. There are over 200 different kinds of woodpeckers. The two largest woodpeckers, the Imperial Woodpecker and the Ivory-billed Woodpecker are most likely extinct. Animals that are extinct are no longer found on Earth.</p><br><p class=\"pQuest text-justify\">Woodpeckers have sharp bills of drilling into wood, and short, stiff tails which help prop them against tree trunks and branches. Woodpeckers also have very long tongues, which help them get at insects deep within trees. Woodpeckers are often heard drumming loudly on trees before they are seen, Woodpeckers can even become pests if they learn to drum on siding of a house.</p><br><p class=\"pQuest text-justify\">Woodpeckers can easily be attracted to backyard bird feeders with sunflower seeds or suet. Suet is a kind of animal fat hat is very tasty to woodpeckers and other birds.</p></div><br> The two largest woodpeckers in the world are:", "normally found at bird feeders", "found all over the world", "most likely no longer on earth", "pests", "C", "Reading<br> Comprehension"],
...
["<div class=\"divQuest text-justify\"><p class=\"pQuest_noIndent text-justify\">Scientist have known for a long time that vitamin D is essential for humans. If children have a vitamin D or calcium deficiency, they can develop rickets, a softening of the bones. New studies are showing that people of all ages need vitamin D to help them fight off diseases by keeping their immune systems strong.</p><br><p class=\"pQuest_noIndent text-justify\">Our bodies can make vitamin D when our skin is exposed to sunlight. However, it’s best to eat a diet that is rich in the vitamin.</p></div><br> When you have a deficiency of something, you ___.", "have all you need", "look like an onion", "do not have enough", "are rich", "C", "Reading<br> Comprehension"],
];
	$(document).ready(function(){				
				...
				//checks if answer is correct and adds to score
					$('#choiceA').click(function(){
						...
						if(ans == questions[val][5]){
							...
							else if(category == "Single Word<br> Analogy")
							{
								Swa++;
							}
							else if(category == "Double Word<br> Analogy")
							{
								Dwa++;
							}
							...
							else if(category == "Logical Organization<br> of Ideas")
							{
								Loi++;
							}
							else
				...
				$('#reSyn').click(function(){
					event.preventDefault();
					newLocation = 'synonyms.html';
					$('body').fadeOut(500, newpage);
				});
				
				$('#reAnt').click(function(){
					event.preventDefault();
					newLocation = 'antonyms.html';
					$('body').fadeOut(500, newpage);
				});
				
				$('#reSwa').click(function(){
					event.preventDefault();
					newLocation = 'swa.html';
					$('body').fadeOut(500, newpage);
				});
				
				$('#reDwa').click(function(){
					event.preventDefault();
					newLocation = 'dwa.html';
					$('body').fadeOut(500, newpage);
				});
				
				$('#reIde').click(function(){
					event.preventDefault();
					newLocation = 'ide.html';
					$('body').fadeOut(500, newpage);
				});
				
				$('#reCus').click(function(){
					event.preventDefault();
					newLocation = 'cus.html';
					$('body').fadeOut(500, newpage);
				});
				
				$('#reLoi').click(function(){
					event.preventDefault();
					newLocation = 'loi.html';
					$('body').fadeOut(500, newpage);
				});
				
				$('#reRec').click(function(){
					event.preventDefault();
					newLocation = 'rec.html';
					$('body').fadeOut(500, newpage);
				});
			});
				var wrong = new Audio();
				...
				function goExam(){
					...
					else if(questions[val][6] == "Single Word<br> Analogy")
					{
						totalSwa++;
						category = "Single Word<br> Analogy";
					}
					else if(questions[val][6] == "Double Word<br> Analogy")
					{
						totalDwa++;
					...
					else if(questions[val][6] == "Logical Organization<br> of Ideas")
					{
						totalLoi++;
						category = "Logical Organization<br> of Ideas";
					}
					else
					{
						totalRec++;
						category = "Reading<br> Comprehension";
					}
